...
export default {
  ...
  methods: {
    ...
    async get_currencies() {
      await axios
        .get(`currencies`, this.$store.state.userheaders)
    ...
    async get_image(id) {
      await axios
        .get(`currencies/${id}`, this.$store.state.userheaders)
        .then(response => response.data)
        .then(response => {
          console.log(response)
    ...
    async get_plans() {
      await axios
        .get(`plan-by-currency/${this.currency}`, this.$store.state.userheaders)
        .then(response => response.data)
        .then(response => {
          this.plans = response
    ...
    async submit() {
      await axios
        .post(`buyplan`, { plan: this.plan, amount: this.amount, option: this.option }, this.$store.state.userheaders)
        .then(response => response.data)
        .then(() => {
